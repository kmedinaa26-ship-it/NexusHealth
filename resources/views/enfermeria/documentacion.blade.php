...
<div style="background:white; padding:1.5rem; border-radius:12px; box-shadow:0 4px 6px rgba(0,0,0,0.04); margin-bottom:1.5rem; display:flex; justify-content:space-between; align-items:center;">
    <div>
        <h3 style="font-weight:800;"><i class="fas fa-file-medical" style="color:#3B82F6;"></i> Expedientes y Documentacion</h3>
...
<div style="background:white; border-radius:12px; box-shadow:0 4px 6px rgba(0,0,0,0.04); margin-bottom:1.25rem; overflow:hidden;">
    ...
    <div id="exp-{{ $p->id }}" style="display:none; padding:1.25rem;">
        ...
        <div style="background:#EFF6FF; padding:0.75rem; border-radius:8px; margin-bottom:1rem; border-left:3px solid #3B82F6;">
            <div style="font-size:0.7rem; font-weight:700; color:#3B82F6; margin-bottom:0.25rem;">ULTIMOS SIGNOS VITALES</div>
        ...
        <div style="margin-bottom:0.5rem;">
            ...
            <div style="border-left:2px solid {{ $e->priority === 'Urgente' ? '#DC2626' : '#94A3B8' }}; padding:0.5rem 0.75rem; margin-bottom:0.5rem; background:#FAFAFA; border-radius:0 6px 6px 0;">
                ...
                <div style="font-size:0.85rem; color:#1E1A17; margin-top:0.15rem;">{{ $e->notes }}</div>
            </div>
            @endforeach
        </div>
        @else
        ...
        <div style="display:flex; gap:0.5rem; margin-top:1rem; padding-top:0.75rem; border-top:1px solid #E2E8F0;">
            <a href="{{ route('enfermeria.signos') }}" style="background:#3B82F6; color:white; padding:0.4rem 0.8rem; border-radius:6px; font-size:0.75rem; font-weight:700; text-decoration:none;"><i class="fas fa-stethoscope"></i> Signos</a>
            <a href="{{ route('enfermeria.evolucion') }}" style="background:#2D9E6A; color:white; padding:0.4rem 0.8rem; border-radius:6px; font-size:0.75rem; font-weight:700; text-decoration:none;"><i class="fas fa-notes-medical"></i> Nota</a>
            <a href="{{ route('enfermeria.hospitalizacion') }}" style="background:#F59E0B; color:white; padding:0.4rem 0.8rem; border-radius:6px; font-size:0.75rem; font-weight:700; text-decoration:none;"><i class="fas fa-bed"></i> Hospitalizar</a>
        </div>
    </div>
</div>
@endforeach
