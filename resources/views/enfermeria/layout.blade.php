...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        body { display: flex; height: 100vh; background: #FFF8F0; color: #1E1A17; }
        ...
        .sidebar-header { padding: 1.25rem; border-bottom: 3px solid; border-image: linear-gradient(to right, #DC2626, #E85D3A, #F59E0B, #10B981, #3B82F6) 1; text-align: center; }
        ...
        .triage-amarillo { background: #F59E0B; color: #1E1A17; }
        .triage-verde { background: #10B981; color: white; }
        .triage-azul { background: #3B82F6; color: white; }
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu-category menu-cat-green">Documentación</div>
