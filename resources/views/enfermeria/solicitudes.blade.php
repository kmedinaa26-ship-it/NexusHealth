...
<div style="background:white; padding:1.5rem; border-radius:12px; box-shadow:0 4px 6px rgba(0,0,0,0.04); margin-bottom:1.5rem;">
    <h3 style="font-weight:800;"><i class="fas fa-prescription-bottle-alt" style="color:#3B82F6;"></i> Solicitudes a Farmacia</h3>
    ...
    @foreach($meds as $med)
        <div style="border:1px solid #E2E8F0; border-radius:8px; padding:1rem;">
            ...
            <div style="display:flex; justify-content:space-between; margin-top:0.5rem;">
                <span style="font-size:0.8rem; font-weight:700; color:{{ $med->stock <= $med->min_stock ? '#DC2626' : '#2D9E6A' }}">Stock: {{ $med->stock }}</span>
