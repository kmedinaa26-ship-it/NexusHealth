...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
    <div style="background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.04);">
        <h3 style="font-weight: 800; margin-bottom: 1.5rem;"><i class="fas fa-prescription" style="color: #2D9E6A;"></i> Dispensar Medicamento</h3>
    ...
    <div>
        <div style="background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.04); margin-bottom: 1.5rem;">
            ...
            <div style="font-size:0.85rem; color:#1E1A17;">
                ...
                <div style="padding:0.5rem 0; border-bottom:1px solid #E5E7EB;"><i class="fas fa-circle" style="color:#2D9E6A; font-size:0.5rem;"></i> <strong>Nivel C:</strong> Cualquier Medico</div>
                <div style="padding:0.5rem 0;"><i class="fas fa-circle" style="color:#3B82F6; font-size:0.5rem;"></i> <strong>Enfermeria:</strong> Solo medicamentos autorizados</div>
            </div>
        </div>
