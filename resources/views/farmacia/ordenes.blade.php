...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
    <h3 style="font-weight: 800; color: #1E1A17;"><i class="fas fa-file-invoice-dollar" style="color:#2D9E6A;"></i> Ordenes de Compra</h3>
    <a href="{{ route('farmacia.crearOrden') }}" style="background:#2D9E6A; color:white; text-decoration:none; padding:0.6rem 1.2rem; border-radius:8px; font-weight:700; font-size:0.85rem;"><i class="fas fa-plus"></i> Nueva Orden</a>
</div>
...
<div style="background: white; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.04); overflow: hidden;">
    <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem;">
        ...
        <tbody>
            ...
            @php $statusColors = ['Borrador' => '#736860', 'Enviada' => '#3B82F6', 'En Transito' => '#FF8C42', 'Recibida' => '#2D9E6A', 'Cancelada' => '#C7291C']; @endphp
            <tr style="border-bottom: 1px solid #E5E7EB;">
                ...
                <td style="padding:0.75rem;">
                    ...
                    <form action="{{ route('farmacia.recibirOrden', $order->id) }}" method="POST" style="display:inline;">
                        @csrf @method('PUT')
                        <button type="submit" style="background:#2D9E6A; color:white; border:none; padding:0.3rem 0.6rem; border-radius:4px; font-weight:700; cursor:pointer; font-size:0.75rem;"><i class="fas fa-check"></i> Recibir</button>
                    </form>
                    @endif
                </td>
            </tr>
