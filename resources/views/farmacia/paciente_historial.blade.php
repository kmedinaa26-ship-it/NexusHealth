...
<div style="background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.04); margin-bottom: 1.5rem;">
    <a href="{{ route('farmacia.dispensacion') }}" style="color:#2D9E6A; text-decoration:none; font-weight:700; font-size:0.85rem;"><i class="fas fa-arrow-left"></i> Volver a Dispensacion</a>
    <h3 style="font-weight: 800; color: #1E1A17; margin-top: 0.5rem;"><i class="fas fa-user" style="color:#2D9E6A;"></i> {{ $patient->patient_name }}</h3>
        ...
        <tbody>
            ...
            <tr style="border-bottom: 1px solid #E5E7EB; {{ $med->interaction_alert ? 'background:#FFF1F0;' : '' }}">
                ...
                <td style="padding:0.75rem;">
                    ...
                    @else
                    <span style="color:#2D9E6A;"><i class="fas fa-check-circle"></i></span>
                    @endif
                </td>
            </tr>
